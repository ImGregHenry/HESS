...
foreach($result->BatteryStatus as $item) {
	...
	try {
		...
		$query = "INSERT INTO BatteryStatus (PeakScheduleID, DeviceID, IsEnabled, RecordTime, RecordTimeMS, CloudRecordTime, CloudRecordTimeMS, PowerLevelValue, PowerLevelPercent) "
			. "VALUES (:peakScheduleID, :deviceID, :isEnabled, :recordTime, :recordTimeMS, :cloudRecordTime, :cloudRecordTimeMS, :powerLevelValue, :powerLevelPercent)";
